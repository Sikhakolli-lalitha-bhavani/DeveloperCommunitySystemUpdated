...
//        when(optional.get()).thenReturn(responseEntity);
//        when(responseDao.save(responseEntity)).thenReturn(responseEntity);
// 
//        // Act
//
//        ResponseDTO result = responseService.updateResponse(1,responseDTO);
// 
//        // Assert
//
//       // assertNotNull(result);
...
// 
    ...
    void testRemoveResponse() throws NoEntityFoundException {
...
//        // Act
//
//        ResponseDTO result = responseService.updateResponse(a,responseDTO);
// 
//        // Assert
//
//        //assertNotNull(result);
